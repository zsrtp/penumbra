...
fn gdb_thread(app_to_gdb: Receiver<GDBCmd>, gdb_to_app: Sender<GDBResponse>) {
...
fn run_gui(app_to_gdb: Sender<GDBCmd>, gdb_to_app: Receiver<GDBResponse>) -> std::thread::Result<()> {
